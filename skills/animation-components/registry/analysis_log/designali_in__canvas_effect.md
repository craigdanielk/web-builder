# designali_in__canvas_effect

**Source:** `21st-dev-library/designali-in/canvas-effect.tsx`
**Component Type:** ui
**Framework:** three.js
...
Classified as **UI** component.   Large component (309 lines) with structural layout.
