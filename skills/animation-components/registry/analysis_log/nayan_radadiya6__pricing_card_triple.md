# nayan_radadiya6__pricing_card_triple

**Source:** `21st-dev-library/nayan_radadiya6/pricing-card-triple.tsx`
**Component Type:** ui
**Framework:** none
...
Classified as **UI** component.   Large component (296 lines) with structural layout.
