# prebuiltui__image_gallery

**Source:** `21st-dev-library/prebuiltui/image-gallery.tsx`
**Component Type:** ui
**Framework:** none
...
Classified as **UI** component. Contains 8 hardcoded content strings.  
