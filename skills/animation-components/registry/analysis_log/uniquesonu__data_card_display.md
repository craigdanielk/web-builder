# uniquesonu__data_card_display

**Source:** `21st-dev-library/uniquesonu/data-card-display.tsx`
**Component Type:** ui
**Framework:** none
...
Classified as **UI** component. Contains 8 hardcoded content strings. Imports 2 shadcn/ui components. 
