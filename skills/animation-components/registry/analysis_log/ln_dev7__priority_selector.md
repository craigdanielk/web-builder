# ln_dev7__priority_selector

**Source:** `21st-dev-library/ln-dev7/priority-selector.tsx`
**Component Type:** ui
**Framework:** none
...
Classified as **UI** component. Contains 14 hardcoded content strings. Imports 3 shadcn/ui components. 
