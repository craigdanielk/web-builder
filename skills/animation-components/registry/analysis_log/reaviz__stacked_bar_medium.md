# reaviz__stacked_bar_medium

**Source:** `21st-dev-library/reaviz/stacked-bar-medium.tsx`
...
Classified as **hybrid** component. Has both significant animation patterns (2 motion elements) and UI structure (31 content strings, 0 UI imports).
