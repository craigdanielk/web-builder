# reaviz__stacked_diverging_bar

**Source:** `21st-dev-library/reaviz/stacked-diverging-bar.tsx`
...
Classified as **hybrid** component. Has both significant animation patterns (2 motion elements) and UI structure (22 content strings, 0 UI imports).
