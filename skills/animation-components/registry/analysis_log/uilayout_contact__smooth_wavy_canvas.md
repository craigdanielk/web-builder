# uilayout_contact__smooth_wavy_canvas

**Source:** `21st-dev-library/uilayout.contact/smooth-wavy-canvas.tsx`
**Component Type:** ui
**Framework:** none
...
Classified as **UI** component.   Large component (282 lines) with structural layout.
