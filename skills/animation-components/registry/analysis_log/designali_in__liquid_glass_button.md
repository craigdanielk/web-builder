# designali_in__liquid_glass_button

**Source:** `21st-dev-library/designali-in/liquid-glass-button.tsx`
**Component Type:** ui
**Framework:** none
**Animation Type:** exit
**Line Count:** 382
...
Classified as **UI** component.   Large component (382 lines) with structural layout.
