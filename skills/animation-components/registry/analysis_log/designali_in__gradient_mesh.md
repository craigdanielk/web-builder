# designali_in__gradient_mesh

**Source:** `21st-dev-library/designali-in/gradient-mesh.tsx`
**Component Type:** ui
**Framework:** none
...
Classified as **UI** component.   Large component (229 lines) with structural layout.
