# barvian__number_flow_transitions

**Source:** `21st-dev-library/barvian/number-flow-transitions.tsx`
**Component Type:** ui
**Framework:** none
...
- No clear exports detected - component may not be directly importable.
