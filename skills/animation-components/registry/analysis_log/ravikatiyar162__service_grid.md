# ravikatiyar162__service_grid

**Source:** `21st-dev-library/ravikatiyar162/service-grid.tsx`
...
- **Triggers:** hover
- **Motion Intents:** scale, bounce, spring, stagger, attention
- **Interaction Intents:** hover
- **Supported Elements:** heading, image
- **Layout Contexts:** any
- **Section Archetypes:** FEATURES, GALLERY
