# tommyjepsen__hero_with_group_of_images_text_and_two_buttons

**Source:** `21st-dev-library/tommyjepsen/hero-with-group-of-images-text-and-two-buttons.tsx`
**Component Type:** ui
**Framework:** none
...
- **Supported Elements:** text, button, image
- **Layout Contexts:** hero, button, text, image
