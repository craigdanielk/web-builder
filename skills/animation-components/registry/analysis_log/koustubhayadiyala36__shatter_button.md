# koustubhayadiyala36__shatter_button

**Source:** `21st-dev-library/koustubhayadiyala36/shatter-button.tsx`
...
- **Motion Intents:** exit, scale, slide, rotate, glow, attention
- **Interaction Intents:** hover, engage
- **Supported Elements:** button
- **Layout Contexts:** button
...
- Default duration: 150ms - 800ms (extracted from code)
