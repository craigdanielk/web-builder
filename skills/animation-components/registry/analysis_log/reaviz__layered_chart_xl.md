# reaviz__layered_chart_xl

**Source:** `21st-dev-library/reaviz/layered-chart-xl.tsx`
...
- **Supported Elements:** text, heading, card
...
Classified as **hybrid** component. Has both significant animation patterns (2 motion elements) and UI structure (15 content strings, 0 UI imports).
