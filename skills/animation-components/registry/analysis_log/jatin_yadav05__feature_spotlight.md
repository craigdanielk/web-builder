# jatin_yadav05__feature_spotlight

**Source:** `21st-dev-library/jatin-yadav05/feature-spotlight.tsx`
**Component Type:** ui
**Framework:** none
**Animation Type:** exit
**Line Count:** 209
...
- **Triggers:** hover
- **Motion Intents:** exit, slide, glow, spotlight
...
Classified as **UI** component.   Large component (209 lines) with structural layout.
