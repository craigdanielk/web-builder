# ahmedmayara__category_bar_chart

**Source:** `21st-dev-library/ahmedmayara/category-bar-chart.tsx`
**Component Type:** ui
**Framework:** none
...
Classified as **UI** component. Contains 14 hardcoded content strings. Imports 4 shadcn/ui components. 
