# reaviz__horizontal_bar_big

**Source:** `21st-dev-library/reaviz/horizontal-bar-big.tsx`
...
Classified as **hybrid** component. Has both significant animation patterns (2 motion elements) and UI structure (17 content strings, 0 UI imports).
