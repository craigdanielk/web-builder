# jatin_yadav05__fluid_canvas

**Source:** `21st-dev-library/jatin-yadav05/fluid-canvas.tsx`
**Component Type:** ui
**Framework:** none
**Animation Type:** exit
**Line Count:** 436
...
- **Motion Intents:** exit, slide, glow
...
Classified as **UI** component.   Large component (436 lines) with structural layout.
