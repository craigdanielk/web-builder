# uniquesonu__horizontal_scroll_carousel

**Source:** `21st-dev-library/uniquesonu/horizontal-scroll-carousel.tsx`
...
- **Motion Intents:** parallax, progress, horizontal_scroll
