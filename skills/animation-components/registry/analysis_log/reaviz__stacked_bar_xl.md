# reaviz__stacked_bar_xl

**Source:** `21st-dev-library/reaviz/stacked-bar-xl.tsx`
...
Classified as **hybrid** component. Has both significant animation patterns (2 motion elements) and UI structure (29 content strings, 0 UI imports).
