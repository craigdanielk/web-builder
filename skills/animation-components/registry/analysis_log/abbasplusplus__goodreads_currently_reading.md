# abbasplusplus__goodreads_currently_reading

**Source:** `21st-dev-library/abbasplusplus/goodreads-currently-reading.tsx`
**Component Type:** ui
**Framework:** none
...
- **Supported Elements:** heading, image
...
Classified as **UI** component. Contains 8 hardcoded content strings.  Large component (211 lines) with structural layout.
