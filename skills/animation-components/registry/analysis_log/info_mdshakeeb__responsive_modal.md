# info_mdshakeeb__responsive_modal

**Source:** `21st-dev-library/info-mdshakeeb/responsive-modal.tsx`
**Component Type:** ui
**Framework:** none
...
- **Interaction Intents:** submit
- **Supported Elements:** button, modal
...
Classified as **UI** component.  Imports 3 shadcn/ui components. Large component (248 lines) with structural layout.
