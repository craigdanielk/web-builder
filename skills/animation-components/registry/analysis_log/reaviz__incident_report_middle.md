# reaviz__incident_report_middle

**Source:** `21st-dev-library/reaviz/incident-report-middle.tsx`
...
Classified as **hybrid** component. Has both significant animation patterns (2 motion elements) and UI structure (7 content strings, 0 UI imports).
