# aceternity__feature_section_with_card_gradient

**Source:** `21st-dev-library/aceternity/feature-section-with-card-gradient.tsx`
**Component Type:** ui
**Framework:** none
...
Classified as **UI** component. Contains 7 hardcoded content strings.  
