# ln_dev7__indevui_context_menu

**Source:** `21st-dev-library/ln-dev7/indevui-context-menu.tsx`
**Component Type:** ui
**Framework:** none
...
- **Interaction Intents:** navigate
- **Supported Elements:** text, nav
- **Layout Contexts:** nav, text
...
Classified as **UI** component.   Large component (208 lines) with structural layout.
