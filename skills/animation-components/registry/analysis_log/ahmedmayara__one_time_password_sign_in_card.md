# ahmedmayara__one_time_password_sign_in_card

**Source:** `21st-dev-library/ahmedmayara/one-time-password-sign-in-card.tsx`
**Component Type:** ui
**Framework:** none
...
- **Supported Elements:** text, card, button
- **Layout Contexts:** card, text
...
Classified as **UI** component.  Imports 5 shadcn/ui components. 
