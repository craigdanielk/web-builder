# intentui__file_trigger

**Source:** `21st-dev-library/intentui/file-trigger.tsx`
...
Classified as **animation** component. Accepts children and wraps them with motion behaviour.  
