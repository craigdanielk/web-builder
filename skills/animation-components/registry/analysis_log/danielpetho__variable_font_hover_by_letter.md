# danielpetho__variable_font_hover_by_letter

**Source:** `21st-dev-library/danielpetho/variable-font-hover-by-letter.tsx`
...
- Default duration: 700ms - 700ms (extracted from code)
